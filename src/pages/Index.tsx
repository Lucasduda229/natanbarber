  ...
  return <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[70vh] text-center px-4 py-12">
        <div className="space-y-4">
          ...
          <a href="https://www.instagram.com/_natan_barber_/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors group">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto animate-fade-in">Agende seu horário de forma rápida e exclusiva</p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in mt-8">
          <Link to="/register">
            <Button size="lg" className="bg-gold-gradient hover:opacity-90 text-background font-semibold px-8 py-6 text-lg rounded-xl shadow-gold-glow transition-all hover:shadow-gold-glow-strong">
              Criar Conta
            </Button>
          </Link>
          
          <Link to="/login">
            <Button size="lg" variant="outline" className="border-primary/50 text-foreground hover:bg-primary/10 px-8 py-6 text-lg rounded-xl transition-all">
              Já tenho conta
            </Button>
          </Link>
        </div>
